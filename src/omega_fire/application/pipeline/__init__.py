...
# <-- INFO DEV ---------------------------------------------------------
# Rôle :
# - Marque le package src/omega_fire/application/pipeline comme importable
# - Sert de regroupement symbolique pour les éléments de pipeline applicatif
# - N'embarque aucune logique métier, seulement la définition du package
#
# Pourquoi dans application/ (charte) :
# - C'est la couche des enchaînements de traitement applicatif
...
# - Les éléments du pipeline seront importés depuis ce package
# - Les modules application/pipeline/* seront consommés sans exposition forcée ici
